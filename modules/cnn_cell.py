...
class CNNCell(Module):
    def __init__(self):
        ...
        self.cnn1 = nn.Conv1d(in_channels=14, out_channels=64, kernel_size=4, stride=2, padding=1)
        self.cnn2 = nn.Conv1d(in_channels=64, out_channels=64, kernel_size=4, stride=2, padding=1)
        self.bn2 = nn.BatchNorm1d(64)
        self.cnn3 = nn.Conv1d(in_channels=64, out_channels=128, kernel_size=4, stride=2, padding=0)
        self.cnn4 = nn.Conv1d(in_channels=128, out_channels=128, kernel_size=4, stride=1, padding=0)
